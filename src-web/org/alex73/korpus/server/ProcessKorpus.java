...
public class ProcessKorpus implements IProcess {
    LuceneDriverKorpus lucene;

    public ProcessKorpus(String dirPrefix) throws Exception {
        lucene = new LuceneDriverKorpus(dirPrefix + "/Korpus-cache/", false);
    }
    ...
    public TextInfo getTextInfo(Document doc) throws Exception {
