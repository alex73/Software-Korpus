...
import { StandardTextRequest } from './StandardTextRequest';
import { UnprocessedTextRequest } from './UnprocessedTextRequest';
...
export class SearchParams extends BaseParams {
...
export class ClusterParams extends BaseParams {
