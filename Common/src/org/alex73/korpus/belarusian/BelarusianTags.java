...
public class BelarusianTags {
    ...
    private void licebnik(TagLetter t) {
        ...
        z = z.add("Склон => N:назоўны;G:родны;D:давальны;A:вінавальны;I:творны;L:месны;X:???????");
    ...
    private void prymietnik(TagLetter t) {
        ...
        t = t.add("Склон => N:назоўны;G:родны;D:давальны;A:вінавальны;I:творны;L:месны");
    ...
    private void dziejeprymietnik(TagLetter t) {
        ...
        t = t.add("Склон => N:назоўны;G:родны;D:давальны;A:вінавальны;I:творны;L:месны;H:???????");
        t = t.add("Лік => S:адзіночны;P:множны;X:???????");
        pt.add("Кароткая форма => R:жаночы і ніякі");
    }
